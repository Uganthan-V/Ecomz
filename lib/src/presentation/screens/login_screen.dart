...
// // //     return Scaffold(
// // //       extendBodyBehindAppBar: true, // Allows background to extend under status bar
// // //       body: Container(
...
// // //               children: [
// // //                 const SizedBox(height: 60), // Add spacing for status bar
// // //                 const Text(
// // //                   'Welcome baaaaaaack!',
...
// //   @override
// //   Widget build(BuildContext context) {
// //     return SafeArea( // Add SafeArea to respect status bar
// //       child: Scaffold(
// //         extendBodyBehindAppBar: true, // Allows background to extend under status bar
// //         body: Container(
// //           decoration: const BoxDecoration(
